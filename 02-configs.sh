...
echo -e "➞ [${Gre}*${Whi}] Symlinking directories in .local/share/fonts"

mkdir -p ~/.local/share/fonts
stow -t ~/.local/share/fonts .fonts

# --------

cd ~/.dotfiles

echo -e "➞ [${Gre}*${Whi}] Symlinking directories in .starship"

mkdir -p ~/.starship
stow -t ~/.starship .starship
